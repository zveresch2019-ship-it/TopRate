...
const translations = {
  ru: {
    ...
    'help.purpose': 'Система предназначена для определения индивидуального уровня игроков в командных любительских играх с более-менее постоянными участниками и разной разбивкой на команды.',
    'help.how_works': 'Как работает рейтинг:',
    'help.add_players': '• Создайте свою группу и наполните её любым количеством игроков. Для удобства даётся шаблонный набор, который можно корректировать.',
    ...
    'help.rating_changes': '• Вводите результаты матчей и смотрите, как меняются личные рейтинги игроков',
    ...
    'help.main_tab': '• На главной вкладке вы управляете своим аккаунтом (для выхода или удаления нажмите на кнопку с именем), выбираете вид спорта, можете начать новый сезон (рейтинги сохранятся, а статистика матчей, побед/поражений и голов обнулится) и выгрузить рейтинг для друзей.',
    'help.ratings_tab': '• На вкладке «Рейтинг» управляйте игроками: администратор может добавлять, переименовывать и удалять, остальные участники только просматривают.',
    'help.matches_tab': '• На вкладке «Матчи» вводите результат игры: кнопками A и B добавляйте игроков, задавайте счёт, смотрите параметры расчёта и после сохранения возвращайтесь в «Рейтинг», чтобы увидеть изменения.',
    'help.seasons_title': '',
    'help.seasons_stats': '',
    'help.new_season': '',
    'help.goal': '',
  ...
  en: {
    ...
    'help.purpose': 'The system is designed to determine the individual level of players in team amateur games with more or less consistent participants and different team divisions.',
    'help.how_works': 'How the rating works:',
    'help.add_players': '• Create your group and fill it with any number of players. A starter template is provided and can be adjusted as needed.',
    ...
    'help.rating_changes': '• Enter match results and see how personal player ratings change',
    ...
    'help.main_tab': '• On the Home tab you manage your account (tap your name to sign out or delete), switch sports, launch a new season (ratings stay, match stats reset) and export the table for friends.',
    'help.ratings_tab': '• On the Rating tab you manage players: admins can add, rename or remove players while everyone else has view-only access.',
    'help.matches_tab': '• On the Matches tab you record game results: use buttons A and B to assign players, enter the score, tap Parameters to check the math, then save and open Rating to see the changes.',
    'help.seasons_title': '',
    'help.seasons_stats': '',
    'help.new_season': '',
    'help.goal': '',
