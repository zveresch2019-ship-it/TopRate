          ...
          {players.length === 0 ? (
            ...
            <View style={styles.tableContainer}>
              ...
              <View style={styles.tableHeader}>
                ...
                <Text style={[styles.tableHeaderCell, styles.ratingColumn]}>Стало</Text>
                <Text style={[styles.tableHeaderCell, styles.gamesColumn]}>Игры</Text>
                <Text style={[styles.tableHeaderCell, styles.seasonColumn]}>За сезон</Text>
              </View>
              ...
              {sortedPlayers.map((player, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Text style={[styles.tableCell, styles.ratingColumn, styles.currentRatingText]}>
                      {player.rating}
                    </Text>
